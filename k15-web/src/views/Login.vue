...
<!--            <input type="text" placeholder="用户名">-->
<!--            <input type="password" placeholder="密码">-->
              <el-form class="" :model="userForm" status-icon :rules="rules" ref="userForm">
                <el-form-item  prop="username">
                <el-input  placeholder="账户" type="text" v-model="userForm.username"></el-input>
                </el-form-item>
...
export default {
  ...
  data: function() {
    return {
      ...
      flag:true,
      pre_box: document.querySelector('.pre-box'),
